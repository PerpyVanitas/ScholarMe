...
`;
    ...
    console.error("Error generating flashcards for Android:", error);
    return NextResponse.json({ success: false, error: { message: error.message || "Failed to generate flashcards" } }, { status: 500 });
  }
}
