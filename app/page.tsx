        ...
        <section className="relative pt-32 pb-24 px-6 overflow-hidden">
          ...
          <div className="max-w-6xl mx-auto relative z-10">
            ...
            >
              <Link
                href={isLoggedIn ? "/dashboard" : "/auth/sign-up"}
                className="group inline-flex items-center gap-2 px-8 py-4 bg-[#4a3300] text-white dark:bg-[#ffd700] dark:text-[#111111] rounded-2xl font-extrabold text-base shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-0.5"
              >
