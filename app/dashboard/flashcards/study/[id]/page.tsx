...
import {
  StudyModeTabs,
  StudySetData,
} from "../../../quizzes/components/study-mode-tabs";

export default function FlashcardsStudyModePage({
  params,
}: {
  ...
  const handleDuplicateSet = async () => {
    ...
    try {
      ...
      const res = await fetch("/api/v1/flashcards/create", {
        method: "POST",
      ...
      toast.success("Flashcard set duplicated to your library!");
      router.push("/dashboard/study-sets");
    } catch {
