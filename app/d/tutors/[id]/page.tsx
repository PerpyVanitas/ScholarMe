 ...
 * 4. Redirects to /d/sessions where the new booking appears
 *
 * DYNAMIC ROUTE: /d/tutors/[id]
    ...
    return (
      <div className="flex flex-col items-center gap-4 py-16">
        ...
        <Button asChild variant="outline">
          <Link href="/d/tutors">Back to Tutors</Link>
        </Button>
      </div>
    );
  }
  ...
  return (
    <div className="flex flex-col gap-6 max-w-3xl">
      <Button asChild variant="ghost" className="w-fit -ml-2">
        <Link href="/d/tutors" className="flex items-center gap-1">
