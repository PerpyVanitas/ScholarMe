...
export function ImageOcclusionViewer({ imageUrl, masks, showAll = false }: ImageOcclusionViewerProps) {
  ...
  return (
    <div className="relative inline-block border rounded-md overflow-hidden bg-muted/20 my-4 max-w-full">
      ...
      <img src={imageUrl} alt="Flashcard visual" className="max-w-full max-h-[50vh] object-contain" draggable={false} />
