          ...
          <CardContent className="flex items-center justify-between p-4">
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col">
                ...
                <Link href="/panel/timesheet" className="text-xs text-primary hover:underline">
                  View timesheet
                </Link>
              </div>
            </div>
        ...
        <Card className="border-border/60">
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            ...
            <Button asChild variant="ghost" size="sm">
              <Link href="/panel/sessions" className="flex items-center gap-1">
        ...
        <Card className="border-border/60">
          ...
          <CardContent className="flex flex-col gap-3">
            <Button asChild variant="outline" className="justify-start h-auto py-3">
              <Link href="/panel/timesheet" className="flex items-center gap-3">
            ...
            <Button asChild variant="outline" className="justify-start h-auto py-3">
              <Link href="/panel/availability" className="flex items-center gap-3">
                <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-primary/10">
            ...
            <Button asChild variant="outline" className="justify-start h-auto py-3">
              <Link href="/panel/sessions" className="flex items-center gap-3">
            ...
            <Button asChild variant="outline" className="justify-start h-auto py-3">
              <Link href="/panel/resources" className="flex items-center gap-3">
