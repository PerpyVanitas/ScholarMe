...
import { AdminStatModal } from "@/components/d/admin-stat-modal"
        ...
        <Card className="border-border/60">
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            ...
            <Button asChild variant="ghost" size="sm">
              <Link href="/d/admin/sessions" className="flex items-center gap-1">
        ...
        <Card className="border-border/60">
          ...
          <CardContent className="flex flex-col gap-3">
            <Button asChild variant="outline" className="justify-start h-auto py-3">
              <Link href="/d/admin/users" className="flex items-center gap-3">
            ...
            <Button asChild variant="outline" className="justify-start h-auto py-3">
              <Link href="/d/admin/cards" className="flex items-center gap-3">
            ...
            <Button asChild variant="outline" className="justify-start h-auto py-3">
              <Link href="/d/admin/analytics" className="flex items-center gap-3">
